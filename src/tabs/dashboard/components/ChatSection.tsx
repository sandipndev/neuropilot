...
import { sendChatMessage, getChatMessages, clearChatMessages } from '../lib/chat-db';
import { checkChromeAIAvailability } from '../lib/chrome-ai';
import type { FocusWithParsedData } from '../hooks/useFocusData';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2 min-h-0">
        ...
        <AnimatePresence>
          {isWaitingForResponse && <LoadingIndicator key="loading" />}
        </AnimatePresence>
