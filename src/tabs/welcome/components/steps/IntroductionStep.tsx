...
const decorativeCircles = [
  ...
  { color: "from-cyan-400 to-blue-400", size: 45, x: 300, y: -300, delay: 0.6 },
  { color: "from-pink-400 to-rose-400", size: 75, x: -520, y: 50, delay: 0.7 },
  {
  ...
  { color: "from-teal-400 to-cyan-400", size: 60, x: 200, y: 320, delay: 0.9 },
  { color: "from-orange-400 to-red-400", size: 55, x: -300, y: 320, delay: 1.0 }
]
...
export const IntroductionStep: React.FC<IntroductionStepProps> = ({
  ...
  useEffect(() => {
    const timers = [
      ...
      setTimeout(() => setScene(2), 6500),
      setTimeout(() => setScene(3), 9000),
      setTimeout(() => setScene(4), 11500)
    ]
            ...
            <div className="w-full max-w-7xl px-8">
              ...
              <motion.div
                ...
                <p className="text-2xl text-slate-400">
                  Your journey to mindful browsing
                </p>
              </motion.div>
                    ...
                    <motion.div
                      ...
                      <div className="backdrop-blur-xl bg-slate-900/80 rounded-2xl p-6 border border-cyan-500/30 shadow-xl">
                        ...
                        <p className="text-slate-300 text-sm leading-relaxed">
                          Watch your attention patterns emerge as you browse
                          naturally
                        </p>
                      </div>
                    </motion.div>
                  ...
                  <motion.div
                    ...
                    <motion.div
                      ...
                      <div className="backdrop-blur-xl bg-slate-900/80 rounded-2xl p-6 border border-purple-500/30 shadow-xl">
                        ...
                        <p className="text-slate-300 text-sm leading-relaxed">
                          Build deep knowledge through sustained, meaningful
                          engagement
                        </p>
                      </div>
                    </motion.div>
                  ...
                  <motion.div
                    ...
                    <motion.div
                      ...
                      <div className="backdrop-blur-xl bg-slate-900/80 rounded-2xl p-6 border border-emerald-500/30 shadow-xl">
                        ...
                        <p className="text-slate-300 text-sm leading-relaxed">
                          Reinforce learning with AI-powered quizzes and
                          insights
                        </p>
                      </div>
                    </motion.div>
            ...
            <div className="relative z-10 max-w-5xl mx-auto">
              ...
              <motion.div
                ...
                <motion.p
                  ...
                  Transform every moment you spend online into an opportunity
                  for growth
                </motion.p>
              </motion.div>
